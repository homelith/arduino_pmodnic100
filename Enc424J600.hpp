/*****************************************************************************
*
* Title        : Microchip ENC424J600 Ethernet Interface Driver
* Author       : Pascal Stang (c) 2005
* Modified by Norbert Truchsess
* Copyright    : GPL V2
*
* This driver provides initialization and transmit/receive
* functions for the Microchip ENC424J600 10Mb Ethernet Controller and PHY.
...
*****************************************************************************/
	...
	//MAJ 22/05/12
	// ENC424J600 ERXFCON Register Bit Definitions
	...
	//MAJ 22/05/12
	// ENC424J600 EIE Register Bit Definitions
	...
	//MAJ 22/05/12
	// ENC424J600 EIR Register Bit Definitions
	...
	//MAJ 22/05/12
	// ENC424J600 ESTAT Register Bit Definitions
	...
	//MAJ 22/05/12
	// ENC424J600 ECON2 Register Bit Definitions
	...
	//MAJ 22/05/12
	// ENC424J600 ECON1 Register Bit Definitions
	...
	//MAJ 22/05/12
	// ENC424J600 MACON1 Register Bit Definitions
	#define MACON1_LOOPBK   0x10
	#define MACON1_RXPAUS   0x04
	#define MACON1_PASSALL  0x02

	//MAJ 22/05/12
	// ENC424J600 MACON2 Register Bit Definitions
	...
	//MAJ 22/05/12
	// ENC424J600 MICMD Register Bit Definitions
	#define MICMD_MIISCAN   0x02
	#define MICMD_MIIRD     0x01

	//MAJ 22/05/12
	// ENC424J600 MISTAT Register Bit Definitions
	#define MISTAT_NVALID   0x04
	#define MISTAT_SCAN     0x02
	#define MISTAT_BUSY     0x01

	//MAJ 22/05/12
	// ENC424J600 PHCON1 Register Bit Definitions
	...
	//MAJ 22/05/12
	// ENC424J600 PHSTAT1 Register Bit Definitions
	...
	//MAJ 22/05/12
	// ENC424J600 PHANLPA Register Bit Definitions
	...
	#define ENC424J600_BANK0_SELECT                     0xC0 // B0SEL
	#define ENC424J600_BANK1_SELECT                     0xC2 // B1SEL
	#define ENC424J600_BANK2_SELECT                     0xC4 // B2SEL
	#define ENC424J600_BANK3_SELECT                     0xC6 // B3SELSPISettings mySetting(20000000, MSBFIRST, SPI_MODE0);
	#define ENC424J600_ETH_RESET                        0xCA // SETETHRST
	#define ENC424J600_FLOW_CONTROL_DISABLE             0xE0 // FCDISABLE
	#define ENC424J600_FLOW_SINGLE                      0xE2 // FCSINGLE
	#define ENC424J600_FLOW_MULTIPLE                    0xE4 // FCMULTIPLE
	#define ENC424J600_FLOW_CLEAR                       0xE6 // FCCLEAR
	#define ENC424J600_SETPKTDEC                        0xCC // SETPKTDEC
	#define ENC424J600_DMA_STOP                         0xD2 // DMASTOP
	#define ENC424J600_DMA_START_CHEKSUM                0xD8 // DMACKSUM
	#define ENC424J600_DMA_START_CHEKSUM_SEED           0xDA // DMACKSUMS
	#define ENC424J600_DMA_START_COPY                   0xDC // DMACOPY
	#define ENC424J600_DMA_START_COPY_SEED              0xDE // DMACOPYS
	#define ENC424J600_SETTXRTS                         0xD4 // SETTXRTS
	#define ENC424J600_ENABLE_RX                        0xE8 // ENABLERX
	#define ENC424J600_DISABLE_RX                       0xEA // DISABLERX
	#define ENC424J600_ENABLE_INTERRUPTS                0xEC // SETEIE
	#define ENC424J600_DISABLE_INTERRUPTS               0xEE // CLREIE
	// Two-Byte Instructions
	#define ENC424J600_READ_BANK_SELECT                 0xC8 // RBSEL
	// Three-Byte Instructions
	#define ENC424J600_WRITE_EGPRDPT                    0x60
	#define ENC424J600_READ_EGPRDPT                     0x62
	#define ENC424J600_WRITE_ERXRDPT                    0x64
	#define ENC424J600_READ_ERXRDPT                     0x66
	#define ENC424J600_WRITE_EUDARDPT                   0xC8
	#define ENC424J600_READ_EUDARDPT                    0x6A
	#define ENC424J600_WRITE_EGPWRPT                    0x6C
	#define ENC424J600_READ_EGPWRPT                     0x6E
	#define ENC424J600_WRITE_ERXWRPT                    0x70 // WRXWRPT
	#define ENC424J600_READ_ERXWRPT                     0x72
	#define ENC424J600_WRITE_EUDAWRPT                   0x74
	#define ENC424J600_READ_EUDAWRPT                    0x76
	#define ENC424J600_READ_CONTROL_REGISTER            0x00
	#define ENC424J600_WRITE_CONTROL_REGISTER           0x40
	#define ENC424J600_READ_CONTROL_REGISTER_UNBANK     0x20
	#define ENC424J600_WRITE_CONTROL_REGISTER_UNBANK    0x22
	#define ENC424J600_BIT_FIELD_SET                    0x80
	#define ENC424J600_BIT_FIELD_CLEAR                  0xA0
	#define ENC424J600_BIT_FIELD_SET_UNBANK             0x24 // BFSU
	#define ENC424J600_BIT_FIELD_CLEAR_UNBAN            0x26 // BFCU
	#define ENC424J600_READ_EGPDATA                     0x28 // RGPDATA
	#define ENC424J600_WRITE_EGPDATA                    0x2A // WGPDATA
	#define ENC424J600_READ_ERXDATA                     0x2C // RRXDATA
	#define ENC424J600_WRITE_ERXDATA                    0x2E // WRXDATA
	#define ENC424J600_READ_EUDADATA                    0x30 // RUDADATA
	#define ENC424J600_WRITE_EUDADATA                   0x32 // WUDADATA
